...
**<:statno:1019935943899222076> VK:** \`${getContent(vk)}\`**DC:** \`${getContent(dc)}\`**Amongus:**\`${getContent(amongus)}\`
...
**<:statno:1019935943899222076> Sleep Room:** \`${getContent(sleep)}\``
            ...
            Data.findOne({
              ...
              if (!rese) {
                text += "\n**❯<:statno:1019935943899222076> **<@" + user.id + "> **kişisinin kayıtlı mesaj verisi yok bu yüzden bilgileri gönderemiyorum.**";
              } else {
                let toplamMessage = [];
                let mesajKanallar = [];
                ...
                text += "\n**<:statno:1019935943899222076>**" + mesasVeriler + " (**Toplam:** \`" + toplamMessage.reduce((a, b) => a + b) + "\`)";
              }
              kisiSayisi++;
