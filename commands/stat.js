          ...
          data.findOne({ user: user.id }, async (err, res) => {
            ...
            if (res) {
              ...
              if (channels.length > 0) {
                embed.addField("<a:yldz:895687765172305940> Kanal Bilgileri", `\`<:statno:1019935943899222076>\` Toplam: \`${getContent(toplam)}\`\n\`<:statno:1019935943899222076>\` Kayıt Odaları: \`${getContent(kayıt)}\`\n\`<:statno:1019935943899222076>\` Public Odaları: \`${getContent(publics)}\`\n\`<:statno:1019935943899222076>\` Sorun Çözme: \`${getContent(sorun)}\`\n\`<:statno:1019935943899222076>\` Terapi Odaları: \`${getContent(terapi)}\`\n\`<:statno:1019935943899222076>\` Stream Odaları: \`${getContent(stream)}\`\n\`<:statno:1019935943899222076>\` Among Us: \`${getContent(amongus)}\`\n\`<:statno:1019935943899222076>\` Vampir Köylü: \`${getContent(vk)}\`\n\`<:statno:1019935943899222076>\` Doğruluk Cesaret: \`${getContent(dc)}\`\n\`<:statno:1019935943899222076>\` Müzik Odaları: \`${getContent(müzik)}\`\n\`<:statno:1019935943899222076>\` Oyun Odaları: \`${getContent(game)}\`\n\`<:statno:1019935943899222076>\` Secret Odalar: \`${getContent(secret)}\`\n\`<:statno:1019935943899222076>\` Sleep Room: \`${getContent(sleep)}\``)
                embed.addField("<a:yldz:895687765172305940> Kanal Sıralaması (" + channelSize + " kanalda bulunmuş)", channels.join("\n"), true)
              }
            }
            Data.findOne({ user: user.id }, (err, rese) => {
              ...
              embed.addField("<a:yldz:895687765172305940> Mesaj Bilgisi", `\`<:statno:1019935943899222076>\` Toplam: \`${toplammessage.reduce((a, b) => a + b)}\`\n\`<:statno:1019935943899222076>\` 24 Saat: \`0\`\n\`<:statno:1019935943899222076>\` 72 Saat: \`0\`\n\`<:statno:1019935943899222076>\` 1 Hafta: \`0\` `, false)
              embed.addField("<a:yldz:895687765172305940> Mesaj Sıralaması (Toplam: " + toplammessage.reduce((a, b) => a + b) + ")", array.join("\n"), false)
