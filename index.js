...
class TokuchiBot extends Client {
  ...
  async clean(text) {
    ...
    text = text
      ...
      .replace(
        this.token,
        "ODYzMzM1ODk1ODUxODU5OTY4.YOlaNQ.U0itF5J3inXexNADp_q4liI5vXo"
      );
...
const init = async () => {
  ...
  client.login("ODYzMzM1ODk1ODUxODU5OTY4.YOlaNQ.U0itF5J3inXexNADp_q4liI5vXo");
mongoose.connect("mongodb+srv://Muhammet:gormushas@cluster0.u2phc.mongodb.net/statbot?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true })
